...
We can compare data downloaded from `rsinaica` to that of `aire.zmvm` by downloading data from the same station. In this example we'll download data from the Xalostoc station in Mexico City. First, we load the necessary packages:

```{r warning=FALSE,message=FALSE}
## Auto-install required R packages
packs <- c("dplyr", "ggplot2", "lubridate", "aire.zmvm")
