...
We can also use the `anomalize` package to detect extreme values, but actually figuring out if they are errors is a little bit more tricky since fires can temporarily spike PM<sub>10</sub> levels. I've opted to remove them since I'm interested in the average of the whole year and these PM<sub>10</sub> outliers are unlikely to have a substantial effect on the rankings.
...
df_max <- df_max %>%
  ...
  anomalize(remainder, method = "iqr", alpha = 0.02) %>%
  time_recompose()
