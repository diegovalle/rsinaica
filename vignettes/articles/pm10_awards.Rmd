...
Filter netwroks that did not collect or report data for at least 47 weeks and 292  days. Set small values as NA
...
```{r}
df_max <- filter(df_max, network_name != "Monclova")
