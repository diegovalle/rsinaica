...
The station Centro located in Guadalajara has a numeric code of 102 (station_id). The ```stations_sinaica``` data.frame also includes the latitude and longitude of all the measuring stations in Mexico (including some that have never reported any data!).
...
data.frame with all the supported parameters, but not all stations support all of them.
